        ...
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
              ...
              Looking for a team player that knows marketing and full
              stack web develpment? Contact me today and let's start working on a project!
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">boboy.zamora@gmail.com</span>
                </dd>
              </dl>
              <ul role="list" className="mt-8 flex space-x-12">
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://www.facebook.com/anthony.zamora.9678067">
                ...
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://github.com/xBOBOYx">
                ...
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://www.instagram.com/xb0boyx/">
